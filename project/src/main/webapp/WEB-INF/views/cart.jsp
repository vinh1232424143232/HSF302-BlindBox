							...
							<table class="table-shopping-cart">
								...
								<c:forEach items="${cartDetails}" var="cartDetail">
									<tr class="table_row">
										...
										<td class="column-4">
											<form action="/hsf/cart/update" method="post">
												<div class="wrap-num-product flex-w m-l-auto m-r-0">
													<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
														<i class="fs-16 zmdi zmdi-minus"></i>
													</div>
													<input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" value="${cartDetail.quantity}">
													<div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
														<i class="fs-16 zmdi zmdi-plus"></i>
													</div>
												</div>
												<div class="wrap-num-product flex-w m-l-auto m-r-0" style="justify-content: center">
