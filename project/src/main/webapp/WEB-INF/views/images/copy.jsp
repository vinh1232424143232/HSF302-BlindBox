                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${brands}" var="brand">
                                <tr>
                                    <td>${brand.id}</td>
                                    <td>
                                        <img src="${brand.url}" alt="Product" style="width: 50px; height: 50px; object-fit: cover;">
                                    </td>
                                    <td>${brand.name}</td>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${products}" var="product">
                                <tr>
                                    <td>${product.id}</td>
                                    <td>
                                        <img src="${product.url}" alt="Product" style="width: 50px; height: 50px; object-fit: cover;">
                                    </td>
                                    <td>${product.name}</td>
                                    <td>$${product.price}</td>
                ...
                <div class="modal-content">
                    ...
                    <form action="/hsf/management/brand/update" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="brandActiveStatus_${brand.id}" name="active" ${brand.active ? 'checked' : ''}>
                                    <label class="custom-control-label" for="brandActiveStatus_${brand.id}">Active Status</label>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
